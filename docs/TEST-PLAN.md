...
| T2 | Đăng nhập cùng tài khoản ở 2 máy | Máy 1 đăng nhập `alice`; máy 2 đăng nhập `alice` | Máy 2 bị từ chối với thông báo rõ ràng (nhóm chốt cách xử lý ở hợp đồng chung) | không | Việt Anh | | |
